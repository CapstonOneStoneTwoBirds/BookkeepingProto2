...
public class MyCustomWidget extends AppWidgetProvider
{
    ...
    public static void updateAppWidget(Context context, AppWidgetManager appWidgetManager, int appWidgetId)
    {
        ...
        System.out.println("Confirm2 -------> " + UpperLimitActivity.t + " / " + UpperLimitActivity.g + " / " + UpperLimitActivity.c);
    ...
    public static void getContent() {
        titleWidget = UpperLimitActivity.t;
        goalWidget = UpperLimitActivity.g;
        accWidget = UpperLimitActivity.c;
    }
